...
(async()=>{
 ...
 if(!stale.policy.visitTriggered||!stale.policy.noBackgroundTimer||!stale.policy.preservesRawHistory)throw new Error('recovery policy mismatch');
 console.log('Stale session recovery smoke passed: 13h recovers, 11h stays open, threshold=12h.');
